...
const placeBid = ({ connection, wallet, amount, auction, bidderPotToken, bidderPotKey, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (bidderPotToken) {
        ...
        bidderPotToken =
            bidderPotKey ||
                (yield mplAuction.AuctionProgram.findProgramAddress([
                    Buffer.from(mplAuction.AuctionProgram.PREFIX),
                    bidderPot.toBuffer(),
...
const burnToken = ({ connection, wallet, account, mint, amount, owner, close = true, }) => __awaiter(void 0, void 0, void 0, function* () {
    const tx = new mplCore.Transaction({ feePayer: wallet.publicKey }).add(splToken.Token.createBurnInstruction(splToken.TOKEN_PROGRAM_ID, mint, account, owner !== null && owner !== void 0 ? owner : wallet.publicKey, [], amount));
    if (close) {
        tx.add(splToken.Token.createCloseAccountInstruction(splToken.TOKEN_PROGRAM_ID, account, wallet.publicKey, owner !== null && owner !== void 0 ? owner : wallet.publicKey, []));
    }
    const txId = yield sendTransaction({ connection, wallet, txs: [tx] });
    return { txId };
});
