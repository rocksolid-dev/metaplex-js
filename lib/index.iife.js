var metaplex = (function (exports, require$$1, require$$1$1) {
  ...
  ***************************************************************************** */
  ...
  const placeBid = ({ connection, wallet, amount, auction, bidderPotToken, }) => __awaiter$g(void 0, void 0, void 0, function* () {
      ...
      return { txId, bidderPotToken, bidderMeta, payingAccount: payingAccount.publicKey };
  });
  ...
  const burnToken = ({ connection, wallet, token, mint, amount, owner, close = true, }) => __awaiter$g(void 0, void 0, void 0, function* () {
